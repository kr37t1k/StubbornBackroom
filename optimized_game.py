...
class OptimizedBackroomsGame(Entity):
    ...
    def setup_performance_optimizations(self):
        ...
        Texture.set_default_minfilter(Texture.FT_linear)
        Texture.set_default_magfilter(Texture.FT_linear)
    ...
    def setup_audio(self):
        ...
        try:
            ...
            if os.path.exists("audio/atomiste.mp3"):
                ...
                pygame.mixer.music.set_volume(0.2)  # Lower volume for performance
