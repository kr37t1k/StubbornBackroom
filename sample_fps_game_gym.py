...
class Enemy(Entity):
    ...
    def respawn(self):
        ...
        # enemies.remove(self)  # This might cause issues with list iteration
...
# 🌐 GAME SETUP
# mouse.traverse_target = scene  # Changed from shootables_parent
...
# 👾 ENEMY SPAWN
enemies = []
for i in range(8):  # Reduced number for performance
    enemy = Enemy(
...
# FPS Game Environment for Gymnasium
class FPSGameEnv(gym.Env):
    """
    FPS Game Environment for Gymnasium
    """
    def __init__(self):
        super(FPSGameEnv, self).__init__()
    ...
    def step(self, action):
        ...
        # In a real implementation, you would need to call update functions
    ...
    def _calculate_reward(self):
        ...
        # This would require tracking enemy kills
...
if __name__ == "__main__":
    ...
    print("Creating FPS Game Gym Environment...")
    obs, info = fps_env.reset()
    print("Initial observation:", obs)
    
    # Run a few steps as an example
    for i in range(10):
        action = fps_env.action_space.sample()  # Random action
