...
const FLICKER_PATH := "res://assets/audio/light_flicker.wav"
...
var entity_player: AudioStreamPlayer3D
var is_muted := false
...
func _ready():
	...
	flicker_player = _create_3d_player("FlickerPlayer", FLICKER_PATH, -10, false)
	entity_player = _create_3d_player("EntityPlayer", ENTITY_PATH, -5, false)
...
func play_entity_sound(position: Vector3):
	if is_muted: return
	entity_player.global_position = position
	entity_player.play()
...
func is_playing(Player:AudioStreamPlayer3D):
